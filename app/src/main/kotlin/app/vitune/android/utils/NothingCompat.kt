...
enum class NothingDevice(val tag: String, val progressChannel: Int) {
    Phone1(tag = Common.DEVICE_20111, progressChannel = Code_20111.D1_1),
    Phone2(tag = Common.DEVICE_22111, progressChannel = Code_22111.C1_1),
    Phone2a(tag = Common.DEVICE_23111, progressChannel = Code_23111.C_1)
}
...
class GlyphInterface(context: Context) : AutoCloseable {
    ...
    private val coroutineScope =
        CoroutineScope(Dispatchers.Main + SupervisorJob() + CoroutineName("GlyphScope"))
